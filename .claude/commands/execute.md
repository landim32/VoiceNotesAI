...
Deploy and run the DevNotes .NET MAUI app on the Android emulator:
...
```bash
dotnet build DevNotes/DevNotes.csproj -f net8.0-android -t:Install -p:AndroidSdkDirectory="C:/Program Files (x86)/Android/android-sdk"
```
