...
Deploy and run the DevNote .NET MAUI app on the Android emulator:
...
```bash
dotnet build DevNote/DevNote.csproj -f net8.0-android -t:Install -p:AndroidSdkDirectory="C:/Program Files (x86)/Android/android-sdk"
```
