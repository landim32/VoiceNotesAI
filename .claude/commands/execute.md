...
Deploy and run the VoiceNotesAI .NET MAUI app on the Android emulator:
...
```bash
dotnet build VoiceNotesAI/VoiceNotesAI.csproj -f net8.0-android -t:Install -p:AndroidSdkDirectory="C:/Program Files (x86)/Android/android-sdk"
```
